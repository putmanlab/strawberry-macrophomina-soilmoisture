...
############################################
# A. Experiment 2 - Drought Stress - Field #
############################################

### set up parameters
## treatments
e1r1.cult.inoc = c("Petaluma_inoculated","Petaluma_control","Monterey_inoculated","Monterey_control")
...
###obtained random number from sampling 1 number from a set of numbers 1 thorugh 1,000,000
sample(1:100000, 1)
...
write_csv(e1r1.des, path=paste("/home/ucr_git/SB-dis-resist_e1r1_randomized_", "seed-", e1r1.seed, "_", format(Sys.time(), "%Y-%m-%d_%H.%M.%S"), ".csv", sep=""), na="", col_names=T, append=T)
